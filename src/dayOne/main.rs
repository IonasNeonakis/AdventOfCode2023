...
const VALID_DAYS: [&str; 9] = ["", "", "three", "", "five", "", "seven", "eight", "nine"];
...
fn is_two(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("two");
}

fn is_three(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("three");
}

fn is_four(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("four");
}

fn is_five(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("five");
}

fn is_six(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("six");
}

fn is_seven(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("seven");
}

fn is_eight(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("eight");
}

fn is_nine(text: &str) -> bool {
    return text.chars().collect::<String>().starts_with("nine");
}
...
fn two_digits(text: &str) -> u32 {
    ...
    for i in 0..text.len() {
        let mut remaining_text = &text[i..text.len()];
...
fn main() {
    let lines = read_lines("src/adventFile.txt");
